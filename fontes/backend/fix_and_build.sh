...
if [ ! -f package.json ]; then
  echo "ERRO: rode na raiz do backend (onde existe package.json)."
  exit 1
fi
...
cat > scripts/fix-tsc-v2.js <<'NODE'
const fs = require("fs");
...
chmod +x scripts/fix-tsc-v2.js

echo "==> Rodando correções v2..."
FIXSTAMP="$STAMP" node scripts/fix-tsc-v2.js
