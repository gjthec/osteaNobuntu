...
export class ListPacienteComponent implements AfterViewInit,  OnDestroy  {
  ...
  userConfig; 
  searchableFields = [] 
  //apiURL: string = environment.PacienteAPIPath;//Campo que é alterável, o nome do campo "variations"+"APIPATH". 
  JSONURL: string = environment.pacienteJSONPath;// Campo que é alterável, o nome do campo "variations"+"JSONPATH". 
  /** 
