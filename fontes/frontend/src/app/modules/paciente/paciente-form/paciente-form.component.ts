...
export class PacienteFormComponent extends BaseResourceFormComponent<Paciente> implements AfterViewInit, OnDestroy { 


  JSONPath : string = environment.pacienteJSONPath; 
...
//  private ngUnsubscribe = new Subject(); 
  ...
  constructor(
    protected pacienteService: PacienteService,//Linha alterável com base na classe 
    protected injector: Injector, 
    private generatedFormFactoryService: GeneratedFormFactoryService, 
    private formGeneratorService: FormGeneratorService 
  ) { 
    super(injector, new Paciente(), pacienteService, Paciente.fromJson);//Linha alterável com base na classe 
