...
@Component({
  selector: 'app-details-agenda',
  templateUrl: './agenda-form.component.html',
  styleUrls: ['./agenda-form.component.scss']
})
export class AgendaFormComponent extends BaseResourceFormComponent<Agenda> implements AfterViewInit, OnDestroy { 


  JSONPath : string = environment.agendaJSONPath; 
...
//  private ngUnsubscribe = new Subject(); 
  ...
  constructor(
    protected agendaService: AgendaService,//Linha alterável com base na classe 
    protected injector: Injector, 
    private generatedFormFactoryService: GeneratedFormFactoryService, 
    private formGeneratorService: FormGeneratorService 
  ) { 
    super(injector, new Agenda(), agendaService, Agenda.fromJson);//Linha alterável com base na classe 
