...
export class ListAgendaComponent implements AfterViewInit,  OnDestroy  {
  ...
  userConfig; 
  searchableFields = [] 
  //apiURL: string = environment.AgendaAPIPath;//Campo que é alterável, o nome do campo "variations"+"APIPATH". 
  JSONURL: string = environment.agendaJSONPath;// Campo que é alterável, o nome do campo "variations"+"JSONPATH". 
  /** 
